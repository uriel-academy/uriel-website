...
async function distributeEnglishUnclassifiedQuestions() {
  try {
    console.log('🔄 Distributing unclassified English Language questions...\n');

    // Read unclassified questions
    const unclassifiedPath = path.join('assets', 'english_questions_by_topic', '_unclassified.json');
    ...
    console.log(`📋 Found ${unclassifiedQuestions.length} unclassified English Language questions`);
    ...
    console.log(`📚 Found ${topicCollections.length} English Language topic collections with existing questions`);
    ...
    console.log('\n' + '='.repeat(70));
    console.log('📊 ENGLISH LANGUAGE REDISTRIBUTION SUMMARY');
    ...
    console.log('\n✅ All unclassified English Language questions have been redistributed!');
    console.log('📍 All English Language questions are now organized into topic collections');
    console.log('\n🎯 Result:');
    console.log('   - All 1526 English Language questions are now in topic collections');
...
distributeEnglishUnclassifiedQuestions();
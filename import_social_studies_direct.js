...
async function importSocialStudiesQuestions() {
  try {
    console.log('🚀 Starting BECE Social Studies Questions Import...\n');
    
    const jsonPath = './assets/bece_json/bece_social_studies_questions.json';
    ...
    console.log(`\n✅ Successfully imported ${totalImported} Social Studies questions!\n`);
    ...
    console.log(`   Subject: Social Studies`);

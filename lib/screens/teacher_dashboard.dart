...
class _TeacherDashboardPageState extends State<TeacherDashboardPage> with TickerProviderStateMixin {
  ...
  final List<Map<String, dynamic>> _navigationItems = [
    ...
    {'icon': Icons.people_rounded, 'label': 'My Students', 'key': 'students'},
    {'icon': Icons.analytics_rounded, 'label': 'Performance', 'key': 'performance'},
    {'icon': Icons.assignment_rounded, 'label': 'Assignments', 'key': 'assignments'},
    {'icon': Icons.chat_rounded, 'label': 'Communication', 'key': 'communication'},
    {'icon': Icons.emoji_events_rounded, 'label': 'Gamification', 'key': 'gamification'},
  ...
  Widget _buildSideNavigation(bool isMediumScreen) {
    final sidebarWidth = _sidebarCollapsed ? 70.0 : (isMediumScreen ? 200.0 : 240.0);
    ...
    return AnimatedContainer(
      ...
      child: Column(
        children: [
          ...
          // Help & Support
          if (!_sidebarCollapsed) Container(
          ...
          Container(
            ...
            child: Column(
              children: [
                CircleAvatar(
                  radius: _sidebarCollapsed ? 16 : (isMediumScreen ? 20 : 24),
                  backgroundColor: const Color(0xFFD62828),
                  child: Text(
                    _teacherName.split(' ')[1][0], // Get first letter of last name
                    style: GoogleFonts.montserrat(
                      fontSize: _sidebarCollapsed ? 14 : (isMediumScreen ? 16 : 18),
                      fontWeight: FontWeight.bold,
                      color: Colors.white,
                    ),
                  ),
          ...
          Expanded(
            child: Column(
              ...
              children: [
                ...
                if (!isSmallScreen && _selectedNavIndex == 0) Text(
                  '${_getGreeting()}, $_teacherName',
                  style: GoogleFonts.montserrat(
                    fontSize: 14,
                ...
                Container(
                  ...
                  child: TextField(
                    decoration: InputDecoration(
                      hintText: 'Search students, subjects...',
              ...
              PopupMenuButton<String>(
                ...
                itemBuilder: (context) => [
                  PopupMenuItem(
                    ...
                    child: Row(
                      children: [
                        const Icon(Icons.assignment_add, size: 20, color: Color(0xFF2ECC71)),
                        const SizedBox(width: 12),
                        Text('Create Assignment', style: GoogleFonts.montserrat()),
                      ],
                    ),
                  ),
                  PopupMenuItem(
                    ...
                    child: Row(
                      children: [
                        const Icon(Icons.campaign, size: 20, color: Color(0xFF2196F3)),
                        const SizedBox(width: 12),
                        Text('Send Announcement', style: GoogleFonts.montserrat()),
                      ],
                    ),
                  ),
                  PopupMenuItem(
                    ...
                    child: Row(
                      children: [
                        const Icon(Icons.assessment, size: 20, color: Color(0xFFFF9800)),
                        const SizedBox(width: 12),
                        Text('Generate Report', style: GoogleFonts.montserrat()),
                      ],
                    ),
                  ),
                ],
                  ...
                  PopupMenuItem(
                    ...
                    child: Row(
                      children: [
                        ...
                        const SizedBox(width: 12),
                        Text('My Classes', style: GoogleFonts.montserrat()),
                      ],
                    ),
                  ),
                  PopupMenuItem(

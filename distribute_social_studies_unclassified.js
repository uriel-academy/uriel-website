...
async function distributeSocialStudiesUnclassifiedQuestions() {
  try {
    console.log('🔄 Distributing unclassified Social Studies questions...\n');

    // Read unclassified questions
    const unclassifiedPath = path.join('assets', 'social_studies_questions_by_topic', '_unclassified.json');
    ...
    console.log(`📋 Found ${unclassifiedQuestions.length} unclassified Social Studies questions`);
    ...
    console.log(`📚 Found ${topicCollections.length} Social Studies topic collections`);
    ...
    console.log('\n' + '='.repeat(70));
    console.log('📊 SOCIAL STUDIES REDISTRIBUTION SUMMARY');
    ...
    console.log('\n✅ All unclassified Social Studies questions have been redistributed!');
    console.log('📍 All Social Studies questions are now organized into topic collections');
    console.log('\n🎯 Result:');
    console.log('   - All 1650 Social Studies questions are now in topic collections');
    console.log('   - Questions are evenly distributed across all 12 topics');
    console.log('   - Users can practice by specific topics or all Social Studies');
...
distributeSocialStudiesUnclassifiedQuestions();